...
let qntnNodes = 12;
const coef1 = 1.0 - 2 * 0.01 - 1 * 0.01 - 0.3;
const coef2 = 1.0 - 2 * 0.005 - 1 * 0.005 - 0.27;
const radius = 15;
...
const nodePositions = Array.from({length: qntnNodes}, (_, i) => {
  const angle = (Math.PI * 2 * i) / qntnNodes - Math.PI/2; 
  return {
...
drawAllNodes(contextNeNapr, "#e272c6", "black", nodePositions);
drawAllNodes(contextNapr, "#e272c6", "black", nodePositions);